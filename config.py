...
class Config(object):
    ...
    if os.environ.get('STRIPE_ACADEMY_PLAN_ID') is None:
        raise EnvironmentError("No Stripe Academy plan ID defined")
    STRIPE_ACADEMY_PLAN_ID = os.environ.get('STRIPE_ACADEMY_PLAN_ID')
