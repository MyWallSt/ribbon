...
class DetailsForm(FlaskForm):
    ...
    subscription_options =  RadioField('Choose variant', validators=[DataRequired()], choices=[('12','12-month access to MyWallSt - $79.99'),('6','6-month access to MyWallSt - $49.99')], description="This is a one-off payment, not an ongoing subscription. Following the gift period, the user will need to subscribe to maintain MyWallSt access.")
